...
echo '\033[36m\033[1mFetching Tornado Web Server...\033[0m\033[39m'
cd ~/
wget https://pypi.python.org/packages/source/t/tornado/tornado-4.1.tar.gz
tar xvzf tornado-4.1.tar.gz
cd tornado-4.1
echo '\033[36m\033[1mBuilding Tornado Web Server...\033[0m\033[39m'
python3 setup.py build
sudo python3 setup.py install

echo '\033[36m\033[1mCleaning up installation...\033[0m\033[39m'
cd ..
rm -r tornado-4.1/
